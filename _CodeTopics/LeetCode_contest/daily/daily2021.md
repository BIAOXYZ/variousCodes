...
| 14 <br>【`LC677 键值映射`】<br>【**特点**：哈希表；字符串；字典树；设计。】 | 15 <br>【`LC319 灯泡开关`】<br>【**特点**：数学；脑筋急转弯。】 || 17 <br>【`LC318 最大单词长度乘积`】<br>【**特点**：位运算。】 | 18 <br>【`e+` `LC563 二叉树的坡度`】<br>【**特点**：DFS。】 | 19 <br>【`LC397 整数替换`】<br>【**特点**：记忆化搜索；[:bulb:][`*`]贪心。】<br>【**其他**：这个题应该就是用动态规划不好做，但是用记忆化搜索好做的。】 ||
||||||||
