...
| 12 <br>【[`LC678. 有效的括号字符串`]()】<br>【**特点**：动态规划；栈；贪心。】 | 13 <br>【`LC447 回旋镖的数量`】<br>【**特点**：哈希表。】 | 14 <br>【`LC524 通过删除字母匹配到字典里最长单词`】<br>【**特点**：双指针[+ 排序]；动态规划；字符串。】 | 15 <br>【`LC162 寻找峰值`】<br>【**特点**：脑筋急转弯；二分查找。】 ||||
||||||||
