...
| 16 <br>【`m+` [`LC421 数组中两个数的最大异或值`](https://leetcode-cn.com/problems/maximum-xor-of-two-numbers-in-an-array/)】<br>【**特点**：位运算；哈希表；字典树。】 | 17 <br>【`e+` `LC993 二叉树的堂兄弟节点`】<br>【**特点**：BFS；DFS；（带深度的遍历）。】 | 18 <br>【`LC1442 形成两个异或相等数组的三元组数目`】<br>【**特点**：位运算；哈希表。】<br>【**其他2**：曾经的周赛题。】 |||||
||||||||
