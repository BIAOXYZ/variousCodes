...
| 5 <br>【[`LC470 用 Rand7() 实现 Rand10()`](https://leetcode-cn.com/problems/implement-rand10-using-rand7/)】<br>【**特点**：[:bulb:][`*`]拒绝采样；数学（概率与统计）；随机化。】 | 6 <br>【[:bulb:][`*`]`LC704 二分查找`】<br>【**特点**：二分查找；递归。】<br>【**其他**：模版题；经典题目。】 ||||||
||||||||
