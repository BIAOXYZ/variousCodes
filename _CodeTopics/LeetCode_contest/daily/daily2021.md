...
|:--:|:--:|:--:|:--:|:--:|:--:|:--:|
|||| 1 <br>【`LC165 比较版本号`】<br>【**特点**：字符串；双指针。】<br>【**其他**：`Python3语法`——`itertools`库里的`zip_longest()`方法。】 | 2 <br>【`剑指 Offer 22 链表中倒数第k个节点`】<br>【**特点**：双指针（快慢指针）。】 | 3 <br>【`面试题 17.14 最小K个数`】<br>【**特点**：排序；堆；快速选择；分治。】 ||
||||||||
