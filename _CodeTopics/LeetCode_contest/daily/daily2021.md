...
| 7 <br>【`LC598 范围求和 II`】<br>【**特点**：数学（矩阵）；脑筋急转弯。】 | 8 <br>【`LC299 猜数字游戏`】<br>【**特点**：哈希表+计数。】<br>【**其他**：`Python语法`——内置函数 `zip` 的使用。】 || 10 <br>【`LC495 提莫攻击`】<br>【**特点**：模拟。】 || 12 <br>【[`LC375 猜数字大小 II`]()】<br>【**特点**：动态规划；记忆化搜索。】 ||
||||||||
