...
|| 12 <br>【`LC179 最大数`】<br>【**特点**：排序。】<br>【**其他**：`Python语法`——`sort()`排序方法使用自定义的比较函数。】 | 13 <br>【`LC783 二叉搜索树节点最小距离`】<br>【**特点**：（中序）DFS。】 | 14 <br>【`LC208 实现 Trie (前缀树)`】<br>【**特点**：[:bulb:][`*`]字典树；设计。】 | 15 <br>【`LC213 打家劫舍 II`】<br>【**特点**：动态规划。】 || 17 <br>【`LC220 存在重复元素 III`】<br>【**特点**：[:bulb:][`*`]滑动窗口 + 有序集合；桶排序。】 |
| 18 <br>【`LC26 删除有序数组中的重复项`】<br>【**特点**：（倒序）遍历中删除；双指针。】 |||||||
||||||||
