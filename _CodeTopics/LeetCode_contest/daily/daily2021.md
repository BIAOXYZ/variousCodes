...
| 10 <br>【`LC228 汇总区间`】<br>【**特点**：数组。】 | 11 <br>【`LC1202 交换字符串中的元素`】<br>【**特点**：并查集。】<br>【[:bulb:][`*`]**其他**：发现了一个更新fa到最终father的好办法：`fa = [find(x) for x in fa]`。】<br>【**其他2**：也就是因为这个题，想到了一个paper的idea。】 | 12 <br>【`Hard` `LC1203. 项目管理`】<br>【**特点**：DFS；图；拓扑排序。】 | 13 <br>【`LC684 冗余连接`】<br>【**特点**：图；树；并查集；DFS；BFS；拓扑排序。】 | 14 <br>【`LC1018 可被 5 整除的二进制前缀`】<br>【**特点**：数组。】<br>【**其他**：无意义pass题。】 |||
||||||||
