...
| 6 <br>【`LC1748 唯一元素的和`】<br>【**特点**：哈希表。】<br>【**其他**：曾经的双周赛题。】 | 【***<ins>正式开工！！！</ins>***】<br> 7 <br>【`LC1405 最长快乐字符串`】<br>【**特点**：贪心+排序；贪心+堆。】 | 8 <br>【`Hard` `LC1001. 网格照明`】<br>【**特点**：。】 | 9 <br>【`e-` `LC2006 差的绝对值为 K 的数对数目`】<br>【**特点**：暴力；[:bulb:][`*`]哈希表。】<br>【**其他**：难度  `e-` 主要是针对trivial的二重for循环遍历，哈希表法其实还算有点技巧，类似于 `LC1. 两数之和` 的一遍哈希表法。】 ||||
||||||||
