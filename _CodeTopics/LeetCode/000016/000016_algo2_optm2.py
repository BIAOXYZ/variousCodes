...
"""
https://leetcode-cn.com/submissions/detail/82221481/
...
"""
"""
# 搞了半天原来最大的优化在i的重复值的跳过。参见18，19行。一下子从超过20.13%的用户到72.15%的用户了。

执行用时：68 ms, 在所有 Python 提交中击败了72.15%的用户
