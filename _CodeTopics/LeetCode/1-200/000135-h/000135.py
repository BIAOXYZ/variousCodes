class Solution(object):
    def candy(self, ratings):
        ...
        for ind in dic['flat']:
            lis[ind] = 1
        # 原因是没考虑到单边波谷的点也可能被更新，实际上单边波谷的点也是取1就可以了。
        # 输入：[1,2,3,5,4,3,2,1,4,3,2,1,3,2,1,1,2,3,4]
        # 错误时打印：[1, 2, 3, 5, 4, 3, 2, 1, 4, 3, 2, 1, 3, 2, 2, 2, 2, 3, 4]，结果49。
        # 正确时打印：[1, 2, 3, 5, 4, 3, 2, 1, 4, 3, 2, 1, 3, 2, 1, 1, 2, 3, 4]，结果47。
        for ind in dic['flat_trough']:
            lis[ind] = 1
        print lis
        return sum(lis)
        
"""
https://leetcode-cn.com/submissions/detail/133380249/
...
执行用时：712 ms, 在所有 Python 提交中击败了5.29%的用户
内存消耗：15.2 MB, 在所有 Python 提交中击败了58.17%的用户
"""
