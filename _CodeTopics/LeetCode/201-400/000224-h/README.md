...
`224. 基本计算器` https://leetcode-cn.com/problems/basic-calculator/solution/ji-ben-ji-suan-qi-by-leetcode-solution-jvir/
- 方法一：括号展开 + 栈
* [x] 额外方法：硬解析硬算
...
那个很长的用例debug的过程：
```
curr s is: (9-(10-(10-0-(3+(8+(0+(8-(10-8-(7-(2+(5+(6+(10+(3+(8+(3-(9+(1+(10+(1-(1+(6-2+0+(10-(9-(3-(3-9-(1-(7+(4-(2+(2-(10+(3+(7-(1-(4+(1+(1-(10-(5-(9+(9-4-(5-(1+8-(2-(1+(1-10-(
this elem is:  (
['(', 9, '-', '(', 10, '-', '(', 10, '-', '(', 3, '+', '(', 8, '+', '(', 0, '+', '(', 8, '-', '(', 2, '-', '(', 7, '-', '(', 2, '+', '(', 5, '+', '(', 6, '+', '(', 10, '+', '(', 3, '+', '(', 8, '+', '(', 3, '-', '(', 9, '+', '(', 1, '+', '(', 10, '+', '(', 1, '-', '(', 1, '+', '(', 4, '+', '(', 10, '-', '(', 9, '-', '(', 3, '-', '(', -6, '-', '(', 1, '-', '(', 7, '+', '(', 4, '-', '(', 2, '+', '(', 2, '-', '(', 10, '+', '(', 3, '+', '(', 7, '-', '(', 1, '-', '(', 4, '+', '(', 1, '+', '(', 1, '-', '(', 10, '-', '(', 5, '-', '(', 9, '+', '(', 5, '-', '(', 5, '-', '(', 9, '-', '(', 2, '-', '(', 1, '+', '(', 0, '-', '('] 
```

另外还碰到了一个别的问题：在LeetCode官方页面运行时`ch.isnumeric()`是可以的，但是自己贴到本地vscode里运行就不行了，查了下换成了`ch.isdigit()`就可以了。应该就是unicode的编码问题吧，先不管了，把链接记一下有空再看了。
- Why isn't isnumeric working? https://stackoverflow.com/questions/23183868/why-isnt-isnumeric-working
